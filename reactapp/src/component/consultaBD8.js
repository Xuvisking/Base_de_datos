...
export default withStyles(styles)(class extends React.Component {
	  ...
	  handleClose = () => {
    	this.setState({ open: false });
	  	...
	  	fetch('http://127.0.0.1:8080/Tabla/BD8/', {
				method: 'POST',
				mode: 'cors',
				body: JSON.stringify({
					Patente: this.state.Patente , FDH: this.state.FDH
			})
		})
				.then(res => res.text())
	  ...
	  render() {
	    ...
	    return (
	      <div className="TabContainer">
                ...
                Numero de vehıculos que pagaron el permiso en un dıa especıfico
                </Typography>
								<div className={classes.root}>
		        <FormControl className={classes.margin}>
		          <InputLabel htmlFor="adornment-FDH">Fecha de vecimiento del permiso</InputLabel>
		          <Input
								id="adornment-FDH"
